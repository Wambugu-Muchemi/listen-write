...
def escribirAI(transcription):
    ...
    issue_category = askpalm(f"{summary} Categorize this summary as any of the following: Router Installation , Change / Add Device ,Product Enquiry ,TV Connection ,SMS Code Issue ,Payment Issue or Other")
